            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>$<?= $room['price'] ?></td>
                        <td>
                            <div class="availability-button <?= $room['availability'] ? 'available' : 'reserved' ?>">
                                <?= $room['availability'] ? '<i class="fas fa-check"></i> Disponible' : '<i class="fas fa-times"></i> Reservada' ?>
                            </div>
                        </td>
                    </tr>
                    <?php endwhile; ?>
